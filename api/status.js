const PROVIDERS = [
  ...
  { id: 'github_gpt', name: 'GitHub (GPT)', key: 'GITHUB_TOKEN', model: 'openai/gpt-4o-mini'},
  ...
  { id: 'cerebras', name: 'Cerebras (Gemma)', key: 'CEREBRAS_API_KEY', model: 'google/gemma-4-31B-it' },
